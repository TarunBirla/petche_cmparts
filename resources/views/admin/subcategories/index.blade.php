...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('admin.subcategories.create') }}" class="bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs px-4 py-2.5 rounded-xl shadow-md transition flex items-center gap-2">
