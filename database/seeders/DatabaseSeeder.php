...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Product::create([
            ...
            'summary' => 'Cast iron housing high efficiency IE3 motor for harsh Sparelyx environments.',
...
<ol>
    <li>UK's leading Sparelyx, industrial, oil and gas spare parts, consumable &amp; MRO reseller globally.</li>
